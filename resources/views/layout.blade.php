...
-->
    ...
    <footer id="footer" class="footer dark-background">
        <div class="container">
            <h3 class="sitename">BMA Lighting Solutions</h3>
            <p>Innovative lighting technologies that combine sustainability, design, and advanced engineering for
                diverse
            ...
            <div class="certifications text-center my-3">
                <span>IEC Certified | Environmental Standards Compliant</span>
            </div>
        </div>
    </footer>
    <!-- Scroll Top -->
